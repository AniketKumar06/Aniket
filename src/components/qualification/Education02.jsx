                ...
                <div className='qualification__data'>
                    ...
                    <div>
                        <h3 className='qualification__name'>
                            K.B.Shai +2 High School
                        </h3>
                        <i class='uil uil-calender icon'></i>
                        <span className='qualification__level'>2014 - 2016</span>
                    </div>
                </div>
            </div>
        </>
